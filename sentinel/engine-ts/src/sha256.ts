/** Pure-TypeScript SHA-256 (FIPS 180-4) over UTF-8 bytes, lowercase hex.
 *
 * No node:crypto — the core must stay dependency-free and portable to
 * React Native / Hermes (DECISIONS.md D3). TextEncoder exists in Node and
 * React Native/Hermes.
 */
